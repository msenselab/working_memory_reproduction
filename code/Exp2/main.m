  ...
  try
    ...
    clc;
      startIntro = ['Trial Sequence: \n\n'  ...
          ...
          '2nd-Memory presentation:  remember the squares   \n \n' ...
          '3rd-Time reproduction:  press and hold the DOWN arrow key  \n\n' ...
...
%     WaitSecs(1);
    ...
    for trialIndex = 1:exp.maxTrls
         ...
         % 2. prepare stimuli at given condition(s)
...
%         WaitSecs(0.25); % wait 250 ms
       ...
       %ITI = 1seconds
        WaitSecs(1);
         %%%%%%%%%%%%%%%%%%%%    
      % choose a circle to test, WM Test Display
