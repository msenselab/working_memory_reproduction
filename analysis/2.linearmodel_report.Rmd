...
if (runModellocally == TRUE){
  runModelonlocal(AllExpData)
}
```
...
write_csv(slopes_spss, paste0(modelPath, '/rlt/Sub_slopes_InP.csv'))
```
...
write_csv(meanInP, paste0(modelPath, '/rlt/Sub_InP.csv'))
write_csv(meanInP, paste0(modelPath, '/rlt/Sub_meanInP.csv'))
```
