...
Exp 3 <-- original Exp 1
Exp 4 <-- original Exp 2
Exp 5 <-- original Exp 3
...
Next, we systematically explore the WM effect on each phase (encoding, reproduction, and none for Exp 4, 5, 3).
...
Data_Exp3 <- AllExpData %>% filter(Exp == 'Exp1')
Data_Exp4 <- AllExpData %>% filter(Exp == 'Exp2')
Data_Exp5 <- AllExpData %>% filter(Exp == 'Exp3')
...
##################################
# Exp 1
plt_WMCrr_Exp1 <- ggplot(WMCrrForExp1, aes(WMSize, mean_WMCrr, 
     ymin = mean_WMCrr - se_WMCrr, ymax = mean_WMCrr + se_WMCrr, group=1))+
  ...
  labs(x = "Memory load", y = "Mean accuracy") + theme_new

# Exp 2
plt_WMCrr_Exp2 = ggplot(WMCrrForExp2, aes(WMSize, mean_WMCrr, 
      ymin = mean_WMCrr - se_WMCrr, ymax = mean_WMCrr + se_WMCrr, group=gap)) + 
...
# Exp 3
plt_WMCrr_Exp3 <- ggplot(WMCrrForExp3, aes(WMSize, mean_WMCrr, 
     ymin = mean_WMCrr - se_WMCrr, ymax = mean_WMCrr + se_WMCrr, group=1))+
  geom_line(stat = "identity", position = position_dodge(width = 0.2)) +
  geom_point(size = 1.5, stat="identity", position=position_dodge(width=0.2)) +
  geom_errorbar(width=.1,  position = position_dodge(width = 0.2)) +
...
# Exp 4
plt_WMCrr_Exp4 <- ggplot(WMCrrForExp4, aes(WMSize, mean_WMCrr, 
     ymin = mean_WMCrr - se_WMCrr, ymax = mean_WMCrr + se_WMCrr, group=1))+
  geom_line(stat = "identity", position = position_dodge(width = 0.2)) +
  geom_point(size = 1.5, stat="identity", position=position_dodge(width=0.2)) +
  geom_errorbar(width=.1,  position = position_dodge(width = 0.2)) +
...
# Exp 5
plt_WMCrr_Exp5 <- ggplot(WMCrrForExp5, aes(WMSize, mean_WMCrr, 
     ymin = mean_WMCrr - se_WMCrr, ymax = mean_WMCrr + se_WMCrr, group=1))+
  geom_line(stat = "identity", position = position_dodge(width = 0.2)) +
  geom_point(size = 1.5, stat="identity", position=position_dodge(width=0.2)) +
  geom_errorbar(width=.1,  position = position_dodge(width = 0.2)) +
...
plt_Exp1 <- ggarrange(plt_WMCrr_Exp1, plt_RprBias_Exp1, plt_SlpIP_Exp1, 
