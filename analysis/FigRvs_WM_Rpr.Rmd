...
# 4. plot correct rates for WM task
```{r}
# Exp 1
...
# 5. plot mean Reproduction biases
```{r}
# Exp 1
...
# 7. combine the figures for each experiment
```{r}
