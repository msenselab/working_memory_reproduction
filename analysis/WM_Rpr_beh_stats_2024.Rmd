...
# plot cv dy duration and memory load based on mRep
...
fig_en = plot_grid(fig_encoding$fig_a, fig_encoding$fig_b, fig_encoding$fig_cv, fig_encoding$fig_c, labels = c('a', 'b', 'c','d'), nrow = 2)
# save figures
...
mWM %>% filter(ExpName == 'Encoding') %>% 
  ezANOVA(dv = m_WMCrr, wid = NSub, within = Load, detailed = TRUE) -> avm
print(avm)
...
fig_reproduction$fig_c = fig_reproduction$fig_c +
  geom_signif(y_position = c(120, 130), xmin = c(1,1), xmax = c(2, 3), annotation = c("*", "***"), vjust = 0.5) +
   scale_y_reverse()


fig_rp = plot_grid(fig_reproduction$fig_a, fig_reproduction$fig_b, fig_reproduction$fig_cv,
                   fig_reproduction$fig_c, labels = c('a', 'b', 'c','d'), nrow = 2)
# save figures
...
fig_both$fig_c = fig_both$fig_c + 
  geom_signif(y_position = c(120, 130), xmin = c(1,1), xmax = c(2, 3), annotation = c("*", "*"), vjust=0.5) + ylim(-150,0) +  scale_y_reverse()

fig_bt = plot_grid(fig_both$fig_a, fig_both$fig_b, fig_both$fig_cv, fig_both$fig_c, labels = c('a', 'b', 'c','d'), nrow = 2)
# save figures
